          ...
          <div class="account-bg">
                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <?php $fattr = array('class' => 'form-signin');
                            ...
                            <div class="form-group row m-t-30 mb-0">
                                <div class="col-12">
                                    <a href="<?php echo site_url();?>main/forgot" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                                </div>
                            </div>
            ...
            <div class="m-t-20">
                <div class="text-center">
                    <p class="text-white">Don't have an account? <a href="<?php echo site_url();?>main/register" class="text-white m-l-5"><b>Sign Up</b></a></p>
                </div>
            </div>
